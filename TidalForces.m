...
%time_simulated = 3.2E7;
%time_lapse = 365 * 24 * 60 * 60;
...
angle_rotation = pi/60;
R = [cos(angle_rotation) -sin(angle_rotation) 0; sin(angle_rotation) cos(angle_rotation) 0; 0 0 1];
 for i = 1:numPoints
...
for clock = 1:time_lapse
    ...
    %centre_mass = 0.25 * ( [X(1) Y(1) Z(1)] + [X(2) Y(2) Z(2)] + [X(3) Y(3) Z(3)] + [X(4) Y(4) Z(4)]);
